...
To get the most out of in-class time together, R-DAVIS will combine video material with in-person discussion and activities that build on the video material for that week. We will post the week's videos on Mondays at the latest. Please come to class having watched the material relevant to that week's lesson.

...
#### Week 6
 ...
 - `r emo::ji("ballot_box_with_check")` `ggplot2` (finish up)
 - `r emo::ji("ballot_box_with_check")` Data import/export (.rda, .rds, file types)

#### Week 7

 - `r emo::ji("ballot_box_with_check")` RMarkdown and literate programming
 - `r emo::ji("ballot_box_with_check")` visualization do's and don'ts

#### Week 8

 - `r emo::ji("ballot_box_with_check")` joins using `dplyr`
 - `r emo::ji("ballot_box_with_check")` `tidyr` (reshape data)

#### Week 9

 - `r emo::ji("ballot_box_with_check")` datetime data in R with `lubridate` (import, manipulate, visualize pipeline for timeseries data)

...
#### Week 3
 ...
 - dplyr (includes a pipeline of import, manipulation, visualization)
 - `r emo::ji("white_check_mark")` `tidyr`: with many datasets

#### Week 4

 - visualization do's and don'ts (Jenny Bryan's site)

#### Week 5

 - Data import (link to Software Carpentry lessons; include a list-- how many different kinds of file extensions-- crowd-sourced list, R can do all of it)
...
#### Week 7
 ...
 - joins (lots of practice! Use Hadley's examples, use ModernDiveR examples)

...
#### Week 2
 ...
 - `r emo::ji("ballot_box_with_check")` Spreadsheets & Project Management (p2)
 - `r emo::ji("ballot_box_with_check")` Intro to R
 - `r emo::ji("ballot_box_with_check")` Data frames & subsetting
 

#### Week 3

 - `r emo::ji("ballot_box_with_check")` `dplyr` (import, manipulation, visualization)

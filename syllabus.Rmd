...
#### Week 6
 ...
 - `r emo::ji("white_check_mark")` `lubridate` (import, manipulate, visualize pipeline time; time series example, CO2 web data, Maelle Salmon's tweet mining)
...
#### Week 8
 ...
 - `r emo::ji("white_check_mark")` spatial (see [Mapping In R](https://ryanpeek.github.io/mapping_in_R/index.html)) 

#### Week 9

 - `r emo::ji("white_check_mark")` custom functions
 - `r emo::ji("white_check_mark")` for loops

...
save(sonif, file = "width.sound.wav")
```
...
<audio controls>
  <source src="width.sound.wav" type="audio/wav">
</audio>

```{r, echo = F, eval = T, warning= F, message = F}
sonif <- sonify(x = iris$Petal.Width, y = iris$Petal.Length)
save(sonif, file = "width.length.sound.wav")
```
...
<audio controls>
  <source src="width.length.sound.wav" type="audio/wav">
</audio>

...
<br>
I want this to be the next line
...
You can set defaults for your document and your chunk options with the `opts_chunk$set` code:
...
Personal note: tables are a total pain. I prefer to use [TablesGenerator](https://www.tablesgenerator.com/) for pick the language I want the table to be in, and you can then paste this code **in the text part**

**Equations**
To make equations, use LaTeX language, bracketed by dollar signs 
Here is one of many LaTeX symbol sheets: https://www.caam.rice.edu/~heinken/latex/symbols.pdf

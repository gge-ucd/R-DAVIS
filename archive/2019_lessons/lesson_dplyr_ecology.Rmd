...
observations found for each factor or combination of factors. For this task, **`dplyr`**
...
1. Spread the `surveys` data frame with `year` as columns, `plot_id` as rows, and the

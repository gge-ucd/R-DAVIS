...
Next we might want to get out dates and times into a single datetime column. How do we get them into one column so we can format it as a datetime? The answer is the `paste` function.

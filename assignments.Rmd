...
```{r, eval=T, echo=F, warning=F, message=F, width = 8, height = 5}
pg %>% 
...
The x axis labels are all scrunched up because the image is so small on this page, but if you make it and then zoom it bigger in RStudio it looks much better.

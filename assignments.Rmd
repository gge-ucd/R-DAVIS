...
Assignments are designed to reinforce the code/lessons covered that week, and provide students a chance to both practice coding and reviewing code. Assignments are to be completed via private repositories each student set up (via [Github Classrooms](https://classroom.github.com/classrooms)). 

...
I am a 3rd year student in the GGE studying environmental governance of agricultural systems -- basically, how public and private stakeholders work together (or not) to help improve environmental outcomes for the food system. I was new to R (and very intimidated) when entering my PhD in 2018, but through a couple courses like R-DAVIS, Introduction to Computational Social Science, and a **a lot** of muddling through self-teaching, I'm now excited about helping promote data literacy. These days, I use R for scraping the web for large amounts of text data (whether it is Tweets scraped from the Twitter API or thousands of policy documents from government agency websites) using packages like `rvest` and `pdftools`, and then analyzing the text based on the `tidytext` package. Teaching R, I really enjoy the opportunity to explain programming in the least jargon-y way possible. It helps me make sure I really know what is going on behind the scenes, and it helps new learners overcome some of the initial hurdles to working in R.
